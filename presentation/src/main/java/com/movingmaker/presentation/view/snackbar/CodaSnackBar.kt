package com.movingmaker.presentation.view.snackbar
...
import com.movingmaker.presentation.databinding.SnackbarCodaBinding
...
class CodaSnackBar(view: View, private val message: String) {
    ...
    private val snackbarBinding: SnackbarCodaBinding =
        DataBindingUtil.inflate(inflater, R.layout.snackbar_coda, null, false)
